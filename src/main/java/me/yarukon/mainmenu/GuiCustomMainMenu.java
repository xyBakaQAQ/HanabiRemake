...
public class GuiCustomMainMenu extends GuiScreen {
    ...
    public void initGui() {
        ...
        butt.add(new GuiMainMenuButton(this, 2, "J", "Mods", () -> mc.displayGuiScreen(new net.minecraftforge.fml.client.GuiModList(this)), .5f));
        butt.add(new GuiMainMenuButton(this, 3, "K", "Options", () -> mc.displayGuiScreen(new GuiOptions(this, this.mc.gameSettings))));
        butt.add(new GuiMainMenuButton(this, 4, "L", "Languages", () -> mc.displayGuiScreen(new GuiLanguage(this, this.mc.gameSettings, this.mc.getLanguageManager()))));
        butt.add(new GuiMainMenuButton(this, 5, "M", "Quit", () -> mc.shutdown()));
